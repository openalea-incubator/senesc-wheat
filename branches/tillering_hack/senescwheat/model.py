...
class SenescenceModel(object):
    ...
    SENESCENCE_MAX_RATE = 0.2E-8 * CONVERSION_FACTOR_20_TO_12 /2  # maximal senescence m² s-1 at 12°C (Tref)
    ...
    def calculate_N_content_total(cls, proteins, amino_acids, nitrates, Nstruct, max_mstruct, mstruct, Nresidual):
        ...
        : Parameters:
            ...
            - `amino_acids` (:class:`float`) - amino acids concentration (µmol N amino acids g-1 mstruct)
            - `nitrates` (:class:`float`) - nitrates concentration (µmol N nitrates g-1 mstruct)
